...
public class ViewAllJob {
    ...
    public ViewAllJob(Stage primaryStage, Integer uid) {
    ...
    private GridPane createJobForm(TableView<Job> table) {
        ...
        form.add(userLbl, 0, 1);
        form.add(userInput, 1, 1);
        form.add(statusLbl, 0, 2);
        form.add(statusInput, 1, 2);  
        form.add(addButton, 9, 2);  
