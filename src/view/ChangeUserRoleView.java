...
public class ChangeUserRoleView {
	...
	public ChangeUserRoleView(Stage primaryStage, Integer uid) {
	...
	private GridPane createAllStaffForm(TableView<User> table) {
        ...
        newroleLbl = new Label("New User Role");
...
//        
        ...
        form.add(newroleLbl, 0, 1);
        form.add(newroleInput, 1, 1);
        form.add(changeButton, 10, 1);
        form.add(backButton, 11, 1);
